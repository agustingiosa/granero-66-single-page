...
window.addEventListener('scroll', function() {
  ...
  var footer = document.getElementsByClassName('pie-pagina')[0];
  var footerPosition = footer.getBoundingClientRect().top + window.pageYOffset;
  var windowHeight = window.innerHeight;

  if (window.pageYOffset > 100 && window.pageYOffset + windowHeight < footerPosition) {
